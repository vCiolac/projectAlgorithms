...
* Data para entrega no prazo regular: `02/02/2024 14:00`.
...
* Use o comando: `git clone git@github.com:tryber/sd-032-b-project-algorithms.git`.
* Entre na pasta do repositório que você acabou de clonar:
  * `cd sd-032-b-project-algorithms`
...
* Crie uma branch à qual você vai submeter os `commits` do seu projeto
  ...
  * Exemplo: `git checkout -b joaozinho-sd-032-b-project-algorithms`
...
* Usando o exemplo anterior: `git push -u origin joaozinho-sd-032-b-project-algorithms`

  7. Crie um novo `Pull Request` _(PR)_

* Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-032-b-project-algorithms/pulls)
...
* Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-032-b-project-algorithms/pulls) e confira que o seu _Pull Request_ está criado
...
[FORMULÁRIO DE AVALIAÇÃO DE PROJETO](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH32-B&template=betrybe/sd-0x-project-algorithms)
...
<details>
  ...
  Para estes testes, o requisito será considerado atendido quando a resposta do Pytest for <code>XFAIL(Can Fail)</code> ao invés de <code>PASS</code> ou <code>FAIL</code>.
</details>
